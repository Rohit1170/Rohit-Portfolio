...
export default function Navigationbar() {
  ...
  return (
    <motion.div initial={{opacity:0.2}} animate={{opacity:1}} transition={{delay:0.4,duration:2}} className="flex justify-center">
      <div className="w-11/12   py-4 z-50 fixed top-2 h-16 flex items-center md:justify-between rounded-full bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-90  shadow-lg shadow-gray-900 drop-shadow-lg">
